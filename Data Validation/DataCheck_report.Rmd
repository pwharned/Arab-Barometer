...
```{r}
abv_en%>%
  filter(Q210%in%c(98,99, NA, 4), Q211%nin%c(NA))%>%
...
abv%>%
  filter(splita==1&country!=9)%>%
  filter_at(c("Q108_1", "Q108_2","Q108_3","Q108_4"), any_vars(.%in%c(NA)))%>%
  select(country, id, splita, Q108_1,Q108_2,Q108_3, Q108_4, Q301A)
```
