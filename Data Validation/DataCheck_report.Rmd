...
abv%>%
  ...
  select(id, Q602_4A, country, splita, Q1012, Q1012A)
```
...
abv%>%
  ...
  select(id, Q604B_1,Q604B_3, country, splita)
```
...
abv %>% 
  ...
  select(starts_with("Q605A"), id, country)
...
abv %>% 
  ...
  select(starts_with("Q605A"), id, country, splita)
```
...
abv%>%
  ...
  filter(Q1012!=1)%>%
  select(starts_with("Q607"),id, country, Q1012, Q1012A) 
```
